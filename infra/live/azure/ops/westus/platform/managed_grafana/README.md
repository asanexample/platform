# Azure Managed Grafana Module - West US (Ops)

## Overview
This module provisions and configures an Azure Managed Grafana instance in the West US region for the operations environment. The Grafana instance provides a sophisticated visualization and monitoring platform for metrics and logs from various data sources.
...
- Enables creation of comprehensive dashboards for operations monitoring
...
- **Grafana Instance Name**: Uses standardized naming convention (`vip-ops-grafana-wus`)

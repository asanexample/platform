...
run "validate_app_node_pool_creation" {
  ...
  assert {
    condition     = azurerm_kubernetes_cluster_node_pool.app_node_pool[0].name == var.app_node_pool_name
  ...
  assert {
    condition     = azurerm_kubernetes_cluster_node_pool.app_node_pool[0].auto_scaling_enabled == var.app_node_pool_enable_auto_scaling

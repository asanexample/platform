...
| <a name="input_tenants"></a> [tenants](#input\_tenants) | Map of tenant names to their configuration | <pre>map(object({<br/>    mode = optional(string, "namespace")<br/>    resource_quota = optional(object({<br/>      cpu           = optional(string, "4")<br/>      memory        = optional(string, "8Gi")<br/>      pods          = optional(number, 20)<br/>      services      = optional(number, 20)<br/>      loadbalancers = optional(number, 0)<br/>      pvcs          = optional(number, 10)<br/>      storage       = optional(string, "50Gi")<br/>    }), {})<br/>  }))</pre> | `{}` | no |

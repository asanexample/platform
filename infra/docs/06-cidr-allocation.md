...
|-------------|----------|--------|
| Platform | `10.100.0.0/16` | In Progress |
| Preprod | `10.101.0.0/16` | Planned |
| Prod | `10.102.0.0/16` | Planned |
...
| Transit | /29 | 6 | Transit Gateway / VPN attachments |

...
- **AKS RBAC**: Integration with Azure AD for Kubernetes RBAC with managed Azure AD configuration.
  - Admin group access controlled via Azure AD groups
...
- **Azure AD Integration**: Using managed Azure AD integration for authentication to the Kubernetes API.
...
- **Regularly Updated Kubernetes Version**: Currently using version 1.32.
...
| Azure AD Integration | Managed AAD RBAC with admin group configuration |

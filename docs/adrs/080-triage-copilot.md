...
`docs/plans/080-triage-copilot-eval-spike.md`. The spike rides the preprod-spoke work (#590/P10) — it needs preprod
scaled up with its observability spoke capturing the test app's telemetry. This is the **first agent built on the substrate**, revising the

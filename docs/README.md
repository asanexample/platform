...
| [Preprod Tenant Model](architecture/preprod-tenant-model.md) | Hybrid namespace/vCluster isolation architecture |
...
| [ADR-027: Hybrid Tenant Isolation](adrs/027-hybrid-tenant-isolation-model.md) | Namespace + vCluster isolation model for preprod |
